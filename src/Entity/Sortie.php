...
class Sortie
{
    ...
    #[ORM\Column]
    private ?int $nmInscriptionMax = null;
    ...
    public function getNmInscriptionMax(): ?int
    {
        return $this->nmInscriptionMax;
    }

    public function setNmInscriptionMax(int $nmInscriptionMax): static
    {
        $this->nmInscriptionMax = $nmInscriptionMax;
